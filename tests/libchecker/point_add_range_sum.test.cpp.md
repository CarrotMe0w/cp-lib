...
data:
  ...
  bundledCode: "#line 2 \"main.hpp\"\n\n#line 2 \"func.hpp\"\n\n#include <bits/stdc++.h>\n\
    ...
    \ 4 \"tests/libchecker/point_add_range_sum.test.cpp\"\n\nint main() {\n  dread(int,\
    \ n, q);\n  dreadv(int, a, n);\n\n  SegTree<AddMonoid<i64>> seg(a);\n\n  fr (q)\
    \ {\n    dread(int, op, u, v);\n    if (op == 0) seg.apply(u, v);\n    else writeln(seg.query(u,\
    \ v));\n  }\n}\n"
  code: "#include \"main.hpp\"\n#include \"ds/segtree.hpp\"\n#include \"monoid/add.hpp\"\
    \n\nint main() {\n  dread(int, n, q);\n  dreadv(int, a, n);\n\n  SegTree<AddMonoid<i64>>\
    \ seg(a);\n\n  fr (q) {\n    dread(int, op, u, v);\n    if (op == 0) seg.apply(u,\
  ...
  verifiedWith: []
documentation_of: tests/libchecker/point_add_range_sum.test.cpp
layout: document
redirect_from:
- /verify/tests/libchecker/point_add_range_sum.test.cpp
- /verify/tests/libchecker/point_add_range_sum.test.cpp.html
